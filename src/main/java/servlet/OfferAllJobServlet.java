...
public class OfferAllJobServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        nvps.add(new BasicNameValuePair("applicant_ids", "" + applicantIDs));
        ...
        try {
            ...
            if(httpResponse.getStatusLine().getStatusCode() == 200){
                String message = "You have successfully offered the jobs!";
