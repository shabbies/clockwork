...
<head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="#services">Hire</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#portfolio">How it works</a>
                        </li>
                        <li>
                          <button class="btn btn-primary wow tada">Login / Register</button>
                      </li>
                  </ul>
              </div>
              <!-- /.navbar-collapse -->
      ...
      <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <a href="#about" class="btn btn-primary btn-xl page-scroll">Find Work (Register now)</a>
                <a href="#about" class="btn btn-primary btn-xl page-scroll">Post your Job (It's free)</a>
            </div>
        </div>
    </header>
            ...
            <div class="container">
              ...
              <form id="searchForm">
                <div class="input-group input-group-lg stylish-input-group">
                    <input type="text" class="form-control" id="searchText" autocomplete="off" placeholder="Lorem">
    ...
    <div class="container">
        ...
        <div>
            <h3>Search Results for "GOODIE BAG"</h3>                             
        </div>

        <div class="col-lg-4" ng-repeat="job in jobs">
            <div class="job-entry">
                ...
                <span class="job-entry-price pull-right"><strong>${{job.pay}}</strong></span>   
            </div>
